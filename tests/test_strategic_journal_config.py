...
def test_config():
    ...
    if ENABLE_STRATEGIC_JOURNAL:
        test_lines.append("Yesterday's HOLD was cautious but we missed gains. Will be more aggressive on clear signals.")
    
    if ENABLE_FEELING_LOG:
        test_lines.append("Feeling more confident after reviewing recent performance metrics.")
    ...
    try:
        decision, prob, explanation, journal, feeling = parse_response_text(test_response)
        print("\n✓ Parsing successful!")
